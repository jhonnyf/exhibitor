...
/***/ "./resources/js/pages/file.init.js":
/*!*****************************************!*\
  !*** ./resources/js/pages/file.init.js ***!
  \*****************************************/
...
var File = function () {
  ...
  var status = function status() {
    var element = $(this);
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(element.attr('href')).then(function (response) {
      var data = response.data;
      var html = data["return"].active === 1 ? '<i data-feather="check-circle"></i>' : '<i data-feather="circle"></i>';
      element.html(html);
      feather.replace();
    });
    return false;
...
/***/ 0:
/*!***************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./resources/js/pages/file.init.js ./resources/scss/console/bootstrap.scss ./resources/scss/console/bootstrap-dark.scss ./resources/scss/console/icons.scss ./resources/scss/console/app-rtl.scss ./resources/scss/console/app.scss ./resources/scss/console/app-dark.scss ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\wamp64\www\exhibitor\resources\js\pages\file.init.js */"./resources/js/pages/file.init.js");
